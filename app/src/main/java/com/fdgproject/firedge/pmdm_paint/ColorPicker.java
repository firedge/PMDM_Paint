...
public class ColorPicker extends Dialog {
    ...
    private static class ColorPickerView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (Color.red(mCurrentColor) + Color.green(mCurrentColor) + Color.blue(mCurrentColor) < 384)
                ...
                mPaint.setColor(Color.BLACK);
            canvas.drawText(getResources().getString(R.string.ok), 74, 340, mPaint);
            ...
            if (Color.red(mDefaultColor) + Color.green(mDefaultColor)
                ...
                mPaint.setColor(Color.BLACK);
            canvas.drawText(getResources().getString(R.string.ok), 202, 340,
                    mPaint);
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(new ColorPickerView(getContext(), l, mInitialColor,
                mDefaultColor));
        setTitle(getContext().getResources().getString(R.string.color_select));
